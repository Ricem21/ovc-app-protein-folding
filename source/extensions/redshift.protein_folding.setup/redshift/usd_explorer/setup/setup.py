...
ICON_PATH = carb.tokens.get_tokens_interface().resolve("${redshift.protein_folding.setup}/data/icons")
...
class SetupExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id: str) -> None:
        ...
        self._layouts_path = carb.tokens.get_tokens_interface().resolve("${redshift.protein_folding.setup}/layouts")
    ...
    def _setup_ui_state_changes(self) -> None:
        ...
        for window in window_titles:
            setting_name = f'/exts/redshift.protein_folding.setup/{window}/visible'
        ...
        self._ui_state_manager.add_settings_copy_dependency(
            source_path="/exts/redshift.protein_folding.setup/Markups/visible",
            target_path="/exts/omni.kit.markup.core/show_icons",
        )

        self._ui_state_manager.add_settings_copy_dependency(
            source_path="/exts/redshift.protein_folding.setup/Waypoints/visible",
    ...
    def _custom_quicklayout_menu(self) -> None:
        ...
        def add_layout_menu_entry(name, parameter, key):
            ...
            layouts_path = carb.tokens.get_tokens_interface().resolve("${redshift.protein_folding.setup}/layouts")
