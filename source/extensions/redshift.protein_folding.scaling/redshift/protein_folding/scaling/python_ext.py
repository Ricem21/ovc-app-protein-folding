...
class MyExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        ...
        if editor_menu:
            self._menu = editor_menu.add_item("Window/Protein Scaling", self.show_window, toggle=True, value=False)
    ...
    def show_window(self, menu_path: str, visible: bool):
        if visible:
            # Create window
            self._window = ui.Window("Protein Scaling", width=300, height=300)
        ...
        editor_menu = omni.kit.ui.get_editor_menu()
        if editor_menu:
            editor_menu.set_value("Window/Protein Scaling", visible)
